package com.example.mymac.csit551_w2_demo1;
...
import static com.example.mymac.csit551_w2_demo1.utils.Utils.APP_TAG;
    ...
    class MyLsnr implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if(view.getId()==R.id.btn1_act1) {
                ...
                textView2.setText("Button 2 is Clicked");
        }
    }
}
